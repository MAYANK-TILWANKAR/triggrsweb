        ...
        <section className="relative block px-4 md:px-6 py-10 md:py-28 bg-[#171717] min-h-screen">
          ...
          <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-6 md:gap-10 pt-8 sm:grid-cols-2 lg:grid-cols-3 px-4">
            ...
            <div className="rounded-3xl border border-white p-4 md:p-8 text-center shadow">
              ...
              <p className="my-3 md:my-4 mb-0 font-normal leading-relaxed tracking-wide text-white text-sm md:text-base">
                From initial consultation to post-launch maintenance, we provide
                complete support to ensure your digital success at every step.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="bg-[#171717] p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-white">
                ...
                <div className="text-center">
                  ...
                  <p className="text-white/80 leading-relaxed">
                    We aim to transform the digital landscape through innovative
                    solutions and meaningful collaborations, making technology
